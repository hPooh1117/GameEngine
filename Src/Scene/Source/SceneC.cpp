...
// ----------------------------------------------------------------------------------------------
    ...
    mpPlayer->GetComponent<NewMeshComponent>()->RegistMesh(MeshTypeID::E_BasicSphere, ShaderType::ESpotLightBump, nullptr, FbxType::EDefault);
    mpPlayer->GetComponent<NewMeshComponent>()->RegistTexture(L"./Data/Images/earthmap.jpg", 0);
    mpPlayer->GetComponent<NewMeshComponent>()->RegistTexture(L"./Data/Images/earthnormal.jpg", 1);
    mpPlayer->GetComponent<NewMeshComponent>()->RegistTexture(L"./Data/Images/earthbump.jpg", 2);
    ...
    mpCat->GetComponent<NewMeshComponent>()->RegistMesh(MeshTypeID::E_SkinnedMesh, ShaderType::ESpotLightPhong, L"./Data/Models/oswell/cat_mdl.fbx", FbxType::EMaya);
    ...
    mpOswell->GetComponent<NewMeshComponent>()->RegistMesh(MeshTypeID::E_SkinnedMesh, ShaderType::ESpotLightPhongForSkinning, L"./Data/Models/oswell/oswell_test1.fbx", FbxType::EMaya);
    ...
    mpShiba->GetComponent<NewMeshComponent>()->RegistMesh(MeshTypeID::E_SkinnedMesh, ShaderType::ESpotLightBump, L"./Data/Models/0810/shiba_mdl.fbx", FbxType::EMaya);
    mpShiba->GetComponent<NewMeshComponent>()->RegistTexture(L"./Data/Models/0810/shina_N.png", 1);
    mpShiba->GetComponent<NewMeshComponent>()->RegistTexture(L"./Data/Models/0810/shiba_H.png", 2);
    ...
    mpField->GetComponent<NewMeshComponent>()->RegistMesh(MeshTypeID::E_StaticMesh, ShaderType::ESpotLightOcean, L"./Data/Models/OBJ/sea/sea.obj", FbxType::EDefault);
    mpField->GetComponent<NewMeshComponent>()->RegistTexture(L"./Data/Models/OBJ/sea/Nsea.png", 1);
    mpField->GetComponent<NewMeshComponent>()->RegistTexture(L"./Data/Models/OBJ/sea/Hsea.png", 2);
